...
async def test():
    ...
    urls = [
        f"https://financialmodelingprep.com/stable/stock_news?tickers=AAPL&limit=5&apikey={api_key}",
        f"https://financialmodelingprep.com/stable/social-sentiment/history?symbol=AAPL&apikey={api_key}"
    ]
